...
total_data1 = pd.read_csv("SmartWater/datapoint1(3009).csv", delimiter=",")
total_data2 = pd.read_csv("SmartWater/datapoint2(0110).csv", delimiter=",")
total_data3 = pd.read_csv("SmartWater/datapoint3(0110).csv", delimiter=",")
total_data4 = pd.read_csv("SmartWater/datapoint4(0110).csv", delimiter=",")
total_data5 = pd.read_csv("SmartWater/datapoint5(0110).csv", delimiter=",")
